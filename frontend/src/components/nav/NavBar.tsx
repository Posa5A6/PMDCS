...
const NavBar : React.FC = () => {
  ...
  return (
    <div className="w-full flex justify-between py-4 items-center pagePadding sticky top-0 z-50 backdrop-blur-lg">
            ...
            <Link to="/" >
                <h1 className="text-2xl font-semibold tracking-wide">PMDCS</h1>
            </Link>
            <div className="hidden md:flex gap-6 min-w-fit text-lg font-medium tracking-wide">
                <Link to="/contact" className="hover:translate-y-1 transition-all ease-in-out duration-200">Contact Us</Link>
                <Link to="/about" className="hover:translate-y-1 transition-all ease-in-out duration-200">About Us</Link>
            </div>
